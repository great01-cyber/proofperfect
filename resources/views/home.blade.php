...
<style>
  ...
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .hero h1 {
    ...
    font-size: clamp(2.8rem, 6vw, 5.5rem); font-weight: 900; line-height: 1.05; letter-spacing: -0.02em;
    max-width: 900px; animation: fadeUp 0.7s 0.1s ease both;
  }
  ...
  .author-name {
    ...
    font-weight: 700; color: var(--ink); letter-spacing: 0.04em; position: relative; display: inline-block;
  }
  .author-name::after {
    content: ''; position: absolute; bottom: -6px; left: 0; right: 0; height: 3px;
    background: linear-gradient(90deg, var(--gold), var(--rust)); border-radius: 2px;
  }
  ...
  .btn-primary {
    ...
    padding: 1rem 2.5rem; font-size: 0.9rem; font-weight: 500; letter-spacing: 0.04em;
  ...
  .btn-outline {
    ...
    padding: 1rem 2.5rem; font-size: 0.9rem; font-weight: 500; letter-spacing: 0.04em;
    text-decoration: none; background: transparent; cursor: pointer; margin-left: 1rem;
  ...
  .mission-box {
    border-left: 3px solid var(--gold); padding: 1rem 1.4rem; background: var(--cream);
    margin: 1.5rem 0; font-size: 0.95rem; line-height: 1.7; color: var(--ink);
    font-style: italic; font-family: 'Playfair Display', serif;
  }
  .credentials { display: flex; flex-direction: column; gap: 1.2rem; }
  .cred-item {
    background: var(--cream); border: 1px solid rgba(201,149,42,0.2);
    padding: 1.4rem 1.6rem; position: relative; overflow: hidden; transition: box-shadow 0.2s;
  }
  ...
  .card {
    background: var(--paper); border: 1px solid rgba(201,149,42,0.2);
    padding: 2.5rem 2rem; position: relative; transition: transform 0.25s, box-shadow 0.25s; overflow: hidden;
  }
  .card::before {
    content: ''; position: absolute; top: 0; left: 0; width: 100%; height: 3px;
    background: linear-gradient(90deg, var(--gold), var(--rust)); transform: scaleX(0); transform-origin: left; transition: transform 0.3s;
  }
  ...
  .step-num {
    ...
    font-family: 'Playfair Display', serif; font-size: 1.3rem; font-weight: 700; color: var(--gold); margin: 0 auto 1.2rem;
  }
  ...
  /* CONFIDENTIALITY */
  .confidentiality {
    background: linear-gradient(135deg, #1a3a2a 0%, #2a4a1a 100%);
    color: var(--cream); padding: 5rem 5%; text-align: center;
  }
  .conf-inner { max-width: 760px; margin: 0 auto; }
  .conf-badge {
    display: inline-block; border: 1.5px solid rgba(144,200,100,0.5);
    padding: 0.3rem 1rem; font-size: 0.7rem; letter-spacing: 0.15em; text-transform: uppercase;
    color: #a0e080; border-radius: 2px; margin-bottom: 1.5rem;
  }
  ...
  .conf-point {
    ...
    padding: 1.2rem 1.4rem; text-align: center; flex: 1; min-width: 160px; max-width: 200px;
  }
  ...
  .form-group select,
  .form-group textarea {
    border: 1.5px solid #ddd; background: var(--cream);
    padding: 0.85rem 1rem; font-size: 0.92rem; font-family: 'DM Sans', sans-serif;
    color: var(--ink); outline: none; transition: border-color 0.2s; border-radius: 0; appearance: none; width: 100%;
  }
  ...
  .gdrive-box {
    background: #eef2ff; border: 1.5px solid #c5d0f0;
  ...
  .copy-email-btn {
    display: inline-block; background: var(--ink); color: var(--cream);
    padding: 0.35rem 1rem; font-size: 0.8rem; border-radius: 2px;
    cursor: pointer; font-family: 'DM Sans', sans-serif; border: none; letter-spacing: 0.03em;
  }
  ...
  .success-msg {
    ...
    background: #f0faf0; border: 1px solid #a8d5a2; margin-top: 1.5rem;
  }
  ...
  .comment-form-wrap {
    background: var(--cream); border: 1px solid rgba(201,149,42,0.25);
    padding: 2rem 2.2rem; margin-bottom: 3rem;
  }
  ...
  .comment-card {
    background: var(--cream); border: 1px solid rgba(201,149,42,0.15);
    padding: 1.5rem 1.8rem; position: relative; animation: fadeUp 0.4s ease both;
  }
  ...
  .comment-avatar {
    ...
    display: flex; align-items: center; justify-content: center;
    font-family: 'Playfair Display', serif; font-size: 0.9rem; font-weight: 700; color: white; flex-shrink: 0;
  }
  ...
  /* FOOTER */
  footer {
    padding: 2.5rem 5%; border-top: 1px solid rgba(201,149,42,0.2);
...
<section class="about" id="about">
  <div class="about-inner">
    ...
    <div class="credentials">
      ...
      <div class="cred-item">
        <div class="cred-icon">🎓</div>
        <h4>MSc — Sheffield Hallam University</h4>
        <p>Completed a Master's degree at Sheffield Hallam, giving me first-hand knowledge of what postgraduate academic writing demands and how to meet that standard.</p>
      </div>
      <div class="cred-item">
...
<section class="services" id="services">
  ...
  <div class="cards">
    <div class="card">
      ...
      <h3>Assessments</h3>
      <p>Essays, coursework, reports, dissertations — I'll check grammar, clarity, academic tone, and logical flow so your ideas come through as powerfully as possible.</p>
    </div>
    <div class="card">
      <div class="card-icon">🎓</div>
      <h3>Statement of Purpose</h3>
      <p>Your SOP is your first impression. I'll help it sound confident, compelling, and human — exactly what admissions panels want to see.</p>
    </div>
    <div class="card">
...
<section class="how-it-works" id="how">
  ...
  <div class="steps">
    <div class="step">
      ...
      <h4>Your Email Only</h4>
      <p>Just your email address — nothing else. No name, no institution, no personal data required.</p>
    </div>
    <div class="step">
      <div class="step-num">2</div>
      <h4>Share a Google Doc</h4>
      <p>Paste a Google Docs link with Commenter access. Your document stays entirely in your control.</p>
    </div>
    <div class="step">
      <div class="step-num">3</div>
      <h4>I Review It</h4>
      <p>I personally go through your document and leave detailed feedback directly inside the Google Doc.</p>
    </div>
    <div class="step">
      <div class="step-num">4</div>
      <h4>You Get Notified</h4>
      <p>You'll receive an email from me within 48 hours confirming your feedback is ready to review.</p>
    </div>
    <div class="step">
  ...
  <div class="conf-inner">
    ...
    <div class="conf-points">
      <div class="conf-point">
        ...
        <h4>One Person Only</h4>
        <p>Only I review your document. No team, no algorithm, no third party ever sees it.</p>
      </div>
      <div class="conf-point">
        <div class="cp-icon">🔐</div>
        <h4>Never Shared</h4>
        <p>Your document will never be published, stored externally, or shared with anyone.</p>
      </div>
      <div class="conf-point">
...
<section class="submit-section" id="submit">
  ...
  <form id="proofForm" onsubmit="handleSubmit(event)">
    ...
    <div class="form-group">
      ...
      <textarea placeholder="e.g. Please check my grammar and academic tone. I'm applying for an MSc at UCL and I'm worried about my introduction. Any concerns are welcome..."></textarea>
    </div>
